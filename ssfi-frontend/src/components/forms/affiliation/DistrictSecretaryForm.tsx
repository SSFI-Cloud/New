...
import { useDistrictSecretaryRegistration, useRegistrationStatus } from '@/lib/hooks/useAffiliation';
...
export default function DistrictSecretaryRegistrationForm() {
    ...
    const { register: registerSecretary, isLoading } = useDistrictSecretaryRegistration();
    ...
    useEffect(() => {
        fetchStatus('DISTRICT_SECRETARY');
        fetchStates();
    ...
    const onSubmit = async (data: FormData) => {
        try {
            const result = await registerSecretary(data as DistrictSecretaryFormData);
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
            <div className="max-w-3xl mx-auto px-4 py-8">
                ...
                >
                    ...
                    <h1 className="text-3xl font-bold text-white mb-2">District Secretary Registration</h1>
                    <p className="text-slate-400">Fill in the details below to register as a District Secretary</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className={`w-full px-4 py-3 bg-slate-900/50 border rounded-xl text-white focus:outline-none focus:ring-2 ${errors.districtId ? 'border-red-500 focus:ring-red-500/50' : 'border-slate-700 focus:ring-blue-500/50'
                                ...
                                {errors.districtId && <p className="mt-1 text-sm text-red-400">{errors.districtId.message}</p>}
                            </div>
