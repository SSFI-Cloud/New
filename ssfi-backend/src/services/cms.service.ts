...
export const listGalleryAlbums = async (query: any) => {
  const { page = 1, limit = 20, status, eventId } = query;
  const skip = (page - 1) * limit;
...
export default {
  ...
  // News
  createNews, updateNews, getNewsBySlug, listNews, getNewsCategories, deleteNews,
  // Gallery
  createGalleryAlbum, updateGalleryAlbum, listGalleryAlbums, getGalleryAlbumBySlug,
  addGalleryItem, updateGalleryItem, deleteGalleryItem, deleteGalleryAlbum,
  // Menus
  createMenu, updateMenu, getMenuByLocation, getAllMenus, deleteMenu,
  // Settings
